  ...
  return (
    <div>
      ...
      <div className='min-h-screen w-full bg-[url("/images/section2Image.jpg")] bg-cover bg-center bg-no-repeat'>
        <div className='min-h-screen w-full bg-black/65 flex flex-col justify-center items-center gap-4 lg:flex lg:flex-col lg:justify-center lg:items-center lg:gap-2'>
          <div className='text-3xl text-amber-100'>Associates</div>

          <div className='text-amber-50 flex flex-col justify-center gap-5 lg:flex lg:flex-row lg:h-[20rem] lg:justify-center lg:gap-5'>
